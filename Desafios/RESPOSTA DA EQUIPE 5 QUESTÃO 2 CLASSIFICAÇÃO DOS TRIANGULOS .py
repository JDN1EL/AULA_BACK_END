#- Faça uma função que receba três valores e verifique se é possível criar um triangulo e
# informe qual o tipo de triangulo.
...
# "Se a soma entre os dois lados não for maior que o terceiro, esse triângulonão pode não existir"
equ = ("Equilátero")
esc = ("Escaleno")
iso = ("Isósceles")
