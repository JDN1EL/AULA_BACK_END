   ...
   for rodada in range (1, tt +1):
      ...
      if (acertou):
         ...
         if (maior):
            ...
            p = p - pp
   print('Fim do jogo')
if (__name__ == "__main__"): #______ Se nome for igual ao arquivo principal que é esse advinhação.py emtão ele deve execultyar o def jogar()
=======
import random
def jogar():
#ns -> numero secreto, tt -> total de tentativas, r -> rodada, cstr -> chute_str, p -> pontos, pp -> pontos perdidos
   ...
   print('Fim do jogo')
if (__name__ == "__main__"): #______ Se nome for igual ao arquivo principal que é esse advinhação.py emtão ele deve execultyar o def jogar()
>>>>>>> fe8789e763839d210fde1f0fab1a33b3cf739c42
   jogar()#____________________|